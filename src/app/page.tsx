...
export default function LandingPage() {
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "Direct Artisan Partnerships",          description: "Fair collaborations ensuring artisans receive equitable compensation and recognition for their craft.",          imageSrc: "http://img.b2bpic.net/free-photo/group-diverse-teens-young-people-doing-activities-together-celebrating-world-youth-skills-day_23-2151478270.jpg?_wi=1",          imageAlt: "Hands exchanging handcrafted fabric"},
        {
          title: "Sustainable Material Sourcing",          description: "Utilizing locally sourced, environmentally friendly materials that honor both tradition and nature.",          imageSrc: "http://img.b2bpic.net/free-photo/threads-sewing-accessories-basket-top-view_23-2148827173.jpg?_wi=1",          imageAlt: "Close up of luxury raw cotton fibers"},
        {
          title: "Cultural Preservation Initiatives",          description: "Investing in programs that educate and empower the next generation of Ethiopian weavers and designers.",          imageSrc: "http://img.b2bpic.net/free-photo/colorful-texture-background_53876-32080.jpg?_wi=1",          imageAlt: "Ancient Ethiopian pattern designs in a book"},
      ]}
